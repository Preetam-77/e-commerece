...
def create_user():
    ...
    cur = conn.cursor()
    cur.excute("INSTERT INTO users (name,email,password) VALUES (%s,%s,%s)",
...
def create_course():
    ...
    conn = get_db_connection
    cur = conn.cursor()
    cur.excute("INSERT INTO courses (titles,description) VALUES(%s,%s,%s)",
...
def enroll_courses():
    ...
    conn = get_db_connection
    cur = conn.cursor()
    cur.excute("INSERT INTO enrollment (user_id,course_id) VALUES(%s,%s,%s)",
...
def update_progress():
    ...
    conn = get_db_connection
    cur = conn.cursor()
    cur.excute("INSERT INTO progress (USER_id,course_id,progress_precent) VALUES(%s,%s,%s)",
...
def add_quiz():
    ...
    conn = get_db_connection
    cur = conn.cursor()
    cur.excute("INSERT INTO quizzes (course_id,quetsion,answer) VALUES(%s,%s,%s)",
